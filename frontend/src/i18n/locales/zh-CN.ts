export default {
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      git: "同步任意 HTTPS 或 SSH Git 仓库中的文档",
    },
    field: {
      appId: "App ID",
      ...
      gitLatestParent: "版本父目录（可选）",
      gitLatestPattern: "版本目录匹配规则（可选）",
      gitLatestPairHint: "两个字段需同时填写，可自动同步自然版本号最新的目录，例如 versions + version-*",
      gitExtensions: "文件扩展名",
      gitExtensionsHint: "用英文逗号分隔需要同步的文件扩展名",
      gitUsername: "HTTPS 用户名（可选）",
      gitToken: "HTTPS 访问令牌（可选）",
      gitTokenHint: "仅私有 HTTPS 仓库需要填写",
      gitPrivateKey: "SSH 私钥（可选）",
      gitKnownHosts: "SSH known_hosts（SSH 必填）",
      gitKnownHostsHint: "请粘贴已核验的主机公钥行；SSH 连接不会关闭主机密钥校验",
    },
    comingSoon: "即将支持",
    docHint: "在以下地址获取凭证：",
    openDoc: "打开文档",
