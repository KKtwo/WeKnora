export default {
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      git: "HTTPS 또는 SSH Git 저장소에서 문서 동기화",
    },
    field: {
      appId: "App ID",
      ...
      gitLatestParent: "버전 상위 디렉터리 (선택)",
      gitLatestPattern: "버전 디렉터리 패턴 (선택)",
      gitLatestPairHint: "두 값을 함께 설정하면 가장 최신 디렉터리를 선택합니다. 예: versions + version-*",
      gitExtensions: "파일 확장자",
      gitExtensionsHint: "동기화할 확장자를 쉼표로 구분해 입력하세요.",
      gitUsername: "HTTPS 사용자 이름 (선택)",
      gitToken: "HTTPS 액세스 토큰 (선택)",
      gitTokenHint: "비공개 HTTPS 저장소에만 필요합니다.",
      gitPrivateKey: "SSH 개인 키 (선택)",
      gitKnownHosts: "SSH known_hosts (SSH 필수)",
      gitKnownHostsHint: "확인된 호스트 키 줄을 붙여 넣으세요. SSH 호스트 키 검사는 비활성화되지 않습니다.",
    },
    comingSoon: "곧 지원 예정",
