...
\
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      git: 'Sync documents from any HTTPS or SSH Git repository',
    },
    field: {
      appId: 'App ID',
      ...
      gitLatestParent: 'Version parent directory (optional)',
      gitLatestPattern: 'Version directory pattern (optional)',
      gitLatestPairHint: 'Set both fields to automatically sync the newest matching directory, for example versions + version-*.',
      gitExtensions: 'File extensions',
      gitExtensionsHint: 'Comma-separated extensions included in synchronization.',
      gitUsername: 'HTTPS username (optional)',
      gitToken: 'HTTPS access token (optional)',
      gitTokenHint: 'Required only for private HTTPS repositories.',
      gitPrivateKey: 'SSH private key (optional)',
      gitKnownHosts: 'SSH known_hosts (required for SSH)',
      gitKnownHostsHint: 'Paste the verified host key line. SSH connections never disable host key checking.',
    },
